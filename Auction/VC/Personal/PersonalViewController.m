...
-(void)createUserCenter
{
    ...
    tableViewPer = [[UITableView alloc]initWithFrame:CGRectMake(0, 420 * RATIOTYPE_HEIGHT, kScreenWidth,  100 * RATIOTYPE_HEIGHT * 7)];
...
-(void)createData
{
    ...
    NSDictionary *paramater = @{@"client_id":[user objectForKey:@"client_id"]};
